...
class AboutComponent {
    ...
    // private products =[];
    // private category =[];
    constructor(callapi, http) {
        this.callapi = callapi;
        this.http = http;
    }
    ngOnInit() {
        this.callapi.GetDataAsyns('/assets/data/category.json')
            .then((data) => {
            console.log(data);
        })
            .catch((error) => {
...
AboutComponent.ɵfac = function AboutComponent_Factory(t) { return new (t || AboutComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_Services_Services_module__WEBPACK_IMPORTED_MODULE_1__["ServiceModule"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AboutComponent, [{
    ...
    }], function () { return [{ type: _Services_Services_module__WEBPACK_IMPORTED_MODULE_1__["ServiceModule"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }]; }, null); })();
